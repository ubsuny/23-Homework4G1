...
```
   ...
   Copyright [2023] [ubsuny/23-Homework3G5](https://github.com/ubsuny/23-Homework3G5)
    This Github repository includes code originally developed by [ubsuny/23-Homework3G5], and is modified by [ubsuny/23-Homework4G1](https://github.com/ubsuny/23-Homework4G1). Further using the code requires acknowledgement.
